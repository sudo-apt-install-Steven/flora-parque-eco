...
export const PLANTA_STYLE: StyleSpecification = {
  ...
  layers: [
    ...
    },
    {
      ...
      paint: { 'fill-color': '#6a8b90', 'fill-opacity': 0.42 }
    },
    {
      ...
      source: 'park-planta',
      filter: ['==', ['get', 'category'], 'agua'],
      paint: { 'fill-color': '#547880', 'fill-opacity': 0.18 }
    },
    {
    ...
    },
    {
      ...
      source: 'park-planta',
      filter: ['==', ['get', 'category'], 'agua'],
      paint: { 'line-color': '#3d5f66', 'line-width': 1.15, 'line-opacity': 0.88 }
    },
    {
      ...
      paint: { 'fill-color': '#c4a06a', 'fill-opacity': 0.2 }
    },
    {
      ...
      source: 'park-planta',
      filter: ['in', ['get', 'category'], ['literal', ['estrutura_nova', 'playground']]],
      paint: { 'line-color': '#8a6a3a', 'line-width': 1, 'line-dasharray': [3, 2] }
    },
    {
      ...
      paint: { 'line-color': '#f3efe4', 'line-width': 7, 'line-opacity': 0.55 }
    },
    {
      id: 'planta-pistas',
      type: 'line',
      source: 'park-planta',
      filter: ['in', ['get', 'category'], ['literal', ['pista', 'acesso']]],
      paint: { 'line-color': '#6b5a45', 'line-width': 2.2, 'line-opacity': 0.9 }
    },
    {
      ...
      paint: { 'line-color': '#f4f0e4', 'line-width': 5.5, 'line-opacity': 0.62 }
    },
    {
      id: 'planta-caminhos',
      type: 'line',
    ...
    },
    {
      ...
      paint: { 'line-color': '#efe8d6', 'line-width': 7.5, 'line-opacity': 0.78 }
    },
    {
      id: 'planta-ponte',
      type: 'line',
      source: 'park-planta',
      filter: ['in', ['get', 'category'], ['literal', ['estrutura', 'ponte']]],
      paint: { 'line-color': '#7a5a32', 'line-width': 3.2 }
    },
    {
    ...
    },
    {
      ...
      paint: { 'circle-radius': 11, 'circle-color': '#102a26', 'circle-opacity': 0.12 }
    },
    {
      id: 'planta-pontos',
      type: 'circle',
...
export const EXPLORATION_STYLE: StyleSpecification = {
  ...
  layers: [
    ...
    },
    {
      ...
      paint: { 'fill-color': '#5a6d52', 'fill-opacity': 0.18 }
    },
    {
      id: 'exp-veg-stroke',
      type: 'line',
    ...
    },
    {
      ...
      source: 'park-exploration',
      filter: ['==', ['get', 'category'], 'curva_nivel'],
      paint: { 'line-color': '#efe4c4', 'line-width': 2.6, 'line-opacity': 0.28 }
    },
    {
      id: 'exp-contours',
      type: 'line',
      source: 'park-exploration',
      filter: ['==', ['get', 'category'], 'curva_nivel'],
      paint: { 'line-color': '#7a6644', 'line-width': 0.85, 'line-opacity': 0.62 }
    },
    {
      id: 'exp-lago-fill',
      type: 'fill',
      source: 'park-planta',
      filter: ['==', ['get', 'category'], 'agua'],
      paint: { 'fill-color': '#6a8b90', 'fill-opacity': 0.32 }
    },
    {
      id: 'exp-lago-stroke',
      type: 'line',
      source: 'park-planta',
      filter: ['==', ['get', 'category'], 'agua'],
      paint: { 'line-color': '#3d5f66', 'line-width': 1.1, 'line-opacity': 0.82 }
    },
    {
      id: 'exp-trilhas-case',
      type: 'line',
      ...
      paint: { 'line-color': '#efe4c4', 'line-width': 4.4, 'line-opacity': 0.5 }
    },
    {
      id: 'exp-trilhas',
      type: 'line',
      source: 'park-planta',
      filter: ['in', ['get', 'category'], ['literal', ['caminho', 'trilha', 'pista']]],
      paint: { 'line-color': '#6f5430', 'line-width': 1.6, 'line-dasharray': [4, 2.4] }
    },
    {
      id: 'exp-pois-halo',
      type: 'circle',
      ...
      paint: { 'circle-radius': 11, 'circle-color': '#c4a06a', 'circle-opacity': 0.16 }
    },
    {
      id: 'exp-pois-circle',
      type: 'circle',
